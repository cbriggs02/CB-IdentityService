...
public class LoginServiceTests
{
    ...
    ///     Sets up the test fixtures including JWT configuration and initializes the LoginService
    ///     with mock dependencies for unit testing authentication scenarios.
    /// </summary>
    ...
    /// <summary>
    ///     Tests the LoginAsync method when the user is not found in the database.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    ///     Tests the LoginAsync method when the user is not activated in the database.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    ///     Tests the LoginAsync method when the user provides the wrong password.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    ///     Tests the LoginAsync method when all conditions are met.
    /// </summary>
    [Fact]
