...
namespace IdentityServiceApi.Services.Logging.AbstractClasses
{
    ...
    public abstract class PerformanceLoggerServiceBase : AuditLoggerService, IPerformanceLoggerService
    {
        ...
        ///     A factory used to create audit log service result objects.
        /// </param>
        /// <param name="mapper">
        ///     An instance of AutoMapper used for mapping objects during logging.
        /// </param>
        protected PerformanceLoggerServiceBase(ApplicationDbContext context, IParameterValidator parameterValidator, IAuditLoggerServiceResultFactory auditLogServiceResultFactory, IMapper mapper) : base(context, parameterValidator, auditLogServiceResultFactory, mapper)
        {
        }
