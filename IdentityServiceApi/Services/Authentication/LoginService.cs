...
namespace IdentityServiceApi.Services.Authentication
{
    ...
    public class LoginService : ILoginService
    {
        ...
        /// </exception>
        public LoginService(SignInManager<User> signInManager, UserManager<User> userManager, ILoginServiceResultFactory loginServiceResultFactory, IParameterValidator parameterValidator, IUserLookupService userLookupService, IConfiguration configuration)
        {
