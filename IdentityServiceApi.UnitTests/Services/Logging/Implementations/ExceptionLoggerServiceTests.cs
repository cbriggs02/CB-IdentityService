...
namespace IdentityServiceApi.UnitTests.Services.Logging.Implementations
{
    ...
    public class ExceptionLoggerServiceTests
    {
        ...
        public ExceptionLoggerServiceTests()
        {
            ...
            _exceptionLoggerService = new ExceptionLoggerService(_userContextServiceMock.Object, _loggingValidatorMock.Object, _cacheMock.Object, _cacheKeyServiceMock.Object, _cacheServiceMock.Object, _dbContextMock.Object, _parameterValidatorMock.Object, _serviceResultFactoryMock.Object, _mapperMock.Object);
        }
        ...
        {
            //Act & Assert
            Assert.Throws<ArgumentNullException>(() => new ExceptionLoggerService(null, null, null, null, null, null, null, null, null));
        }
