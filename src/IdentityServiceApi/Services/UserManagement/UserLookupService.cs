...
namespace IdentityServiceApi.Services.UserManagement
{
    ...
    ///     @Updated: 2026
    /// </remarks>
    public class UserLookupService(UserManager<User> userManager, IUserLookupServiceResultFactory userLookupServiceResultFactory, IParameterValidator parameterValidator) : IUserLookupService
    {
        private readonly UserManager<User> _userManager = userManager ?? throw new ArgumentNullException(nameof(userManager));
        private readonly IUserLookupServiceResultFactory _userLookupServiceResultFactory = userLookupServiceResultFactory ?? throw new ArgumentNullException(nameof(userLookupServiceResultFactory));
