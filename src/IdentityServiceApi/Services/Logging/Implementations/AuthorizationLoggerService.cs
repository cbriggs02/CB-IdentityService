...
namespace IdentityServiceApi.Services.Logging.Implementations
{
    ...
    public class AuthorizationLoggerService : AuthorizationLoggerServiceBase, IAuthorizationLoggerService
    {
        ...
        public AuthorizationLoggerService(IUserContextService userContextService, ILoggingValidator loggingValidator, IMemoryCache cache, IAuditLogCacheKeyService cacheKeyService,  IAuditLogCacheService cacheService, ApplicationDbContext context, IParameterValidator parameterValidator, IAuditLoggerServiceResultFactory auditLogServiceResultFactory, IMapper mapper) : base(cache, cacheKeyService, cacheService, context, parameterValidator, auditLogServiceResultFactory, mapper)
        {
